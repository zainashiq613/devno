...
//       >
//         <img src="/devno-logo.png" alt="Logo" className="w-35 xl:w-45" />
...
function Navbar({ setShowContactForm }) {
  ...
  // 🔹 scroll spy effect
  useEffect(() => {
    const sections = navLinks.map((item) => document.querySelector(item.link));
    ...
    const observer = new IntersectionObserver(
      ...
      },
      {
        ...
        rootMargin: '-20% 0px -20% 0px', // trigger a bit earlier
      }
    );
