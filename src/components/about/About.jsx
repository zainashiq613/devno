          ...
          {showContactForm && (
            <motion.div
              ...
              className={`${selectedDate ? 'lg:w-full grid grid-cols-12' : 'h-fit'} ${
                showForm ? '!h-fit' : ''
              } w-full bg-white grid grid-cols-12`}
            >
              {!complete &&
              localStorage.getItem('selectedDate') &&
              localStorage.getItem('selectedTime') ? (
                <div className="col-span-12 flex flex-col gap-2 items-center justify-center">
                  <h1 className="text-2xl font-medium text-primary">
                    <span>Awesome!</span> Your meeting is all set.
                  </h1>
                  <p className="text-text-secondary text-sm">
                    Scheduled for{' '}
                    <span className="font-medium text-[#176aea]">
                  ...
                  <p className="text-text-secondary text-sm">
                    Keep an eye out for the details coming your way.
                  </p>
                </div>
              ) : (
                <>
                    ...
                    <>
                      ...
                      {showForm ? (
                        <div className="p-6 h-fit col-span-12 lg:col-span-8">
                          <DetailForm setComplete={setComplete} id={id} />
                        </div>
                      ) : (
                        <>
                          <div
                                  ...
                                  <div key={item} className="grid grid-cols-2 gap-2">
                                    <button
                                      ...
                                      className={`border text-text-secondary hover:text-primary transition-all cursor-pointer rounded-md py-2 ${
                                        item === id ? '!text-primary' : 'col-span-2'
                                      }`}
                                      key={index}
                                    >
                                      {item}
